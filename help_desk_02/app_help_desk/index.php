<?php
  session_start();
  (isset($_GET['email'])) ? $erro_email = $_GET["email"] : $erro_email = 0;
  (isset($_GET['senha'])) ? $erro_senha = $_GET["senha"] : $erro_senha = 0;
  (isset($_GET['err_session'])) ? $erro_sessao = $_GET["err_session"] : $erro_sessao = 0;
?>
